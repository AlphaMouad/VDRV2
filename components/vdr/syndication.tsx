      ...
      <Reveal delay={0.05}>
        <div className="glass-form p-6 mb-8 border border-[rgba(197,160,89,0.2)]">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-[10px] tracking-[0.2em] uppercase text-[#a3a3a3]">
              {sv.structureTitle}
            </h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <div className="glass-form p-4 border border-[rgba(197,160,89,0.2)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.totalLpRaise}</p>
              <p className="gold-text-gradient font-mono text-lg font-bold">{fmt(lpCommitment)}</p>
              <p className="text-[9px] text-[#a3a3a3] mt-0.5">90% of total cost</p>
            </div>
            <div className="glass-form p-4 border border-[rgba(255,255,255,0.06)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.gpCoInvest}</p>
              <p className="font-mono text-lg font-bold text-[#ffffff]">{fmt(gpCommitment)}</p>
              <p className="text-[9px] text-[#a3a3a3] mt-0.5">Aligned GP skin-in-game</p>
            </div>
            <div className="glass-form p-4 border border-[rgba(16,185,129,0.2)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.minTicket}</p>
              <p className="font-mono text-lg font-bold text-[#10B981]">{fmt(macro.minTicketSize)}</p>
            </div>
            <div className="glass-form p-4 border border-[rgba(16,185,129,0.2)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.maxTicket}</p>
            ...
            <div className="glass-form p-4 border border-[rgba(197,160,89,0.15)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.impliedSlots}</p>
              <p className="gold-text-gradient font-mono text-lg font-bold">{impliedSlots}</p>
              <p className="text-[9px] text-[#a3a3a3] mt-0.5">at min ticket</p>
            </div>
          </div>
        </div>
      </Reveal>
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mb-5">
            {presets.map((p) => (
              <button
                ...
                className={cn(
                  "px-3 py-1.5 rounded-md text-[10px] font-mono font-semibold tracking-wider border transition-all duration-200",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            ...
            <div className="glass-form p-5 border border-[rgba(197,160,89,0.25)] text-center">
              <p className="text-[9px] tracking-[0.18em] uppercase text-[#a3a3a3] mb-2">{sv.lpCashLabel}</p>
              <p className="gold-text-gradient font-mono text-3xl font-bold">
                €<AnimatedValue value={slice.projectedLP} format="currency" />
              </p>
              <p className="text-[9px] text-[#a3a3a3] mt-1">{sv.baseCaseLabel}</p>
            </div>
            {/* MOIC */}
            <div className="glass-form p-5 border border-[rgba(197,160,89,0.25)] text-center">
              <p className="text-[9px] tracking-[0.18em] uppercase text-[#a3a3a3] mb-2">
            ...
            <div className="glass-form p-5 border border-[rgba(16,185,129,0.25)] text-center">
              ...
              <p className="text-[9px] text-[#a3a3a3] mt-1">p.a. · {macro.projectMonths}-month hold</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="glass-form p-4 border border-[rgba(255,255,255,0.06)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.netProfitLabel}</p>
              ...
              <p className="text-[9px] text-[#a3a3a3] mt-0.5">{locale === "fr" ? "Profit net cas de base" : "Net profit · base case"}</p>
            </div>
            <div className="glass-form p-4 border border-[rgba(197,160,89,0.1)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.peakDeployedLabel}</p>
            ...
            <div className="glass-form p-4 border border-[rgba(197,160,89,0.1)]">
              <p className="text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] mb-1">{sv.bearCaseYield}</p>
              ...
              <p className="text-[9px] text-[#a3a3a3] mt-0.5">full hospitality pivot · 45% occ.</p>
            </div>
          </div>
        </div>
      </Reveal>
      ...
      <Reveal delay={0.2}>
        <div className="glass-form p-6 mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-[10px] tracking-[0.2em] uppercase text-[#a3a3a3]">{sv.flowTitle}</h2>
          </div>
          <p className="text-xs text-[#a3a3a3] mb-7 leading-relaxed">{sv.flowDesc}</p>
            ...
            {[
              ...
              <div key={i} className="relative flex gap-4 mb-5 last:mb-0">
                <div className="relative z-10 shrink-0 w-10 h-10 rounded-full glass-form border border-[rgba(197,160,89,0.3)] flex items-center justify-center">
                  <span className="text-[10px] font-mono font-bold text-[#C5A059]">{i + 1}</span>
                </div>
                <div className="flex-1 glass-form p-4 rounded-xl border border-[rgba(255,255,255,0.05)]">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex-1">
                      <p className="text-[9px] tracking-[0.15em] uppercase font-mono text-[#a3a3a3] mb-0.5">{step.month}</p>
                      <p className="text-sm font-semibold text-[#ffffff]">{step.title}</p>
                      <p className="text-[11px] text-[#a3a3a3] mt-1 leading-relaxed">{step.sub}</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-[9px] tracking-wider uppercase text-[#a3a3a3] mb-0.5">{step.sign}</p>
          ...
          <div className="mt-6 p-4 rounded-xl border border-[rgba(197,160,89,0.25)] bg-[rgba(197,160,89,0.05)]">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                <p className="text-[9px] tracking-[0.18em] uppercase text-[#a3a3a3] mb-0.5">{sv.peakDeployedLabel}</p>
              ...
              <div className="text-right shrink-0">
                ...
                {vefaRecycled > 0 && (
                  <p className="text-[10px] text-[#10B981] font-mono mt-0.5">{sv.vefaRecycledLabel}: {fmt(Math.round(vefaRecycled))}</p>
                )}
              </div>
            </div>
          </div>
      ...
      <Reveal delay={0.3}>
        <div className="glass-form p-6 mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-[10px] tracking-[0.2em] uppercase text-[#a3a3a3]">{sv.scenarioTitle}</h2>
          </div>
          <p className="text-xs text-[#a3a3a3] mb-5 leading-relaxed">{sv.scenarioDesc}</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[9px] font-mono text-[#a3a3a3] border border-[rgba(255,255,255,0.1)] rounded px-1.5 py-0.5">
                  ...
                  <div className="space-y-3">
                    {/* Primary metric */}
                    <div>
                      <p className="text-[9px] tracking-[0.12em] uppercase text-[#a3a3a3] mb-0.5">
                        {sv.thLpCash}
                      </p>
                      <p className="font-mono text-xl font-bold" style={{ color }}>{fmt(s.lpCash)}</p>
                      {isCatastrophic && (
                        <p className="text-[9px] text-[#10B981] mt-0.5 font-medium">
                    ...
                    <div className="flex justify-between items-end border-t border-[rgba(255,255,255,0.05)] pt-2">
                      <div>
                        <p className="text-[9px] text-[#a3a3a3]">{sv.thMoic}</p>
                    ...
                    {s.isYieldScenario && s.investorAnnualIncome > 0 && (
                      ...
                      >
                        <div>
                          <p className="text-[8px] tracking-[0.12em] uppercase text-[#10B981] opacity-80">
                        ...
                        <div className="text-right">
                          <p className="text-[8px] text-[#a3a3a3]">
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-[rgba(255,255,255,0.06)]">
                  <th className="text-left py-2.5 pr-3 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thScenario}</th>
                  <th className="text-right py-2.5 pr-3 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thProbability}</th>
                  <th className="text-right py-2.5 pr-3 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thLpCash}</th>
                  <th className="text-right py-2.5 pr-3 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thMoic}</th>
                  <th className="text-right py-2.5 pr-3 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thIrr}</th>
                  <th className="text-right py-2.5 text-[9px] tracking-[0.15em] uppercase text-[#a3a3a3] font-normal">{sv.thNetProfit}</th>
                </tr>
              </thead>
              <tbody>
                {scenarioProjections.map((s) => {
                  ...
                  return (
                    <tr key={s.id} className="border-b border-[rgba(255,255,255,0.04)] last:border-0">
                      ...
                      <td className="py-2.5 pr-3 text-right font-mono text-[#a3a3a3]">
                        {(s.probability * 100).toFixed(0)}%
                      </td>
      ...
      <Reveal delay={0.4}>
        <div className="glass-form p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-[10px] tracking-[0.2em] uppercase text-[#a3a3a3]">{sv.howToTitle}</h2>
          </div>
          <div className="space-y-0">
            {(
              ...
              <div key={i} className="flex gap-4 items-start py-4 border-b border-[rgba(255,255,255,0.04)] last:border-0">
                ...
                <ChevronRight className="w-4 h-4 text-[#a3a3a3] opacity-30 shrink-0 mt-0.5" />
              </div>
            ))}
          </div>
        </div>
